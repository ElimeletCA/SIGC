...
namespace SIGC.Model
{
    public class Paciente
    {
        ...
        public Paciente(int id_paciente, int id_cliente, int id_seguro, int numero_seguro, string fecha_nacimiento, string altura_paciente, string peso_paciente)
        {
